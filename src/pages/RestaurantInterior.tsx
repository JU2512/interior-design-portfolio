...
const plans = [
  { label: "Zoning Layout", src: zoning },
  { label: "Furniture Layout", src: furniture },
  { label: "Flooring Layout", src: flooring },
  { label: "Lighting Layout", src: lighting },
  { label: "Ceiling Layout", src: ceiling },
];
